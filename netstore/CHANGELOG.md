...
- Meningkatkan z-index pada elemen kontainer `header` agar menu navigasi mobile yang berada di dalamnya tidak terperangkap di bawah level stacking `.navbar-overlay` yang memicu tidak dapat dikliknya tautan menu navigasi mobile.
